...
<head>
    ...
    <link href="{{asset('css/libs/bootstrap2.min.css')}}" rel="stylesheet">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i> Drop Down <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="panels-wells.html">Level 1</a>
                            </li>
                            <li>
                                <a href="buttons.html">Level 2</a>
                            </li>
                            <li>
                                <a href="notifications.html">Level 3</a>
                            </li>
                            <li>
                                <a href="typography.html">Level 4</a>
                            </li>
                            <li>
                                <a href="icons.html"> Level 5</a>
                            </li>
                            <li>
                                <a href="grid.html">Level 6</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
...
<script src="{{asset('libs/bootstrap2.min.js')}}"></script>
...
<script src="{{asset('libs/scripts.js')}}"></script>
